<%@page import="commerce.cart.connection.DbCon"%>
<%@page import="java.text.DecimalFormat"%>
<%@page import="commerce.cart.model.*"%>
<%@ page import="java.util.*"%>
<%@ page import="commerce.cart.dao.ProductDao"%>
				...
				<tr>
					...
					<td><form action="order-now" method="post" class="form-inline">
							<input type="hidden" name="id" value="<%=c.getId()%>"
								class="form-input">
							<div class="form-group d-flex justify-content-between w-40">
								<a class="btn btn-sm btn-decre"
									href="quantity-inc-dec?action=dec&id=<%=c.getId()%>"><i
									class="fas fa-minus-square"></i></a> <input type="text"
									name="quantity" class="form-control w-40"
